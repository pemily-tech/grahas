...
>(({ className, children, isError, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      'rounded-8 placeholder:text-muted-foreground focus:border-primary flex h-[48px] w-full items-center justify-between whitespace-nowrap border bg-transparent px-12 py-8 focus:border-2 focus:outline-none disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1',
      isError &&
