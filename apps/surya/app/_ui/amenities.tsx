		...
		<div className="container">
			<div className="rounded-12 my-8 bg-white p-16">
				...
				<div className="grid grid-cols-3 gap-12">
					...
					<div className="col-span-1 flex flex-col items-center justify-center border p-16">
						<ImagePlaceholder src="/images/children.png" containerClasses="w-24 h-24" />
						<span>Kids Play Area</span>
					</div>
					<div className="col-span-1 flex flex-col items-center justify-center border p-16">
						<ImagePlaceholder src="/images/gym.png" containerClasses="w-24 h-24" />
						<span>Gym</span>
					</div>
					<div className="col-span-1 flex flex-col items-center justify-center border p-16">
						<ImagePlaceholder src="/images/tennis.png" containerClasses="w-24 h-24" />
					...
					<div className="col-span-1 flex flex-col items-center justify-center border p-16">
						<ImagePlaceholder src="/images/yoga.png" containerClasses="w-24 h-24" />
						<span>Yoga</span>
					</div>
					<div className="col-span-1 flex flex-col items-center justify-center border p-16">
						<ImagePlaceholder
